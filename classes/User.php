    ...
    class User extends Database{
        ...
        public function update($request, $files){
            ...
            if ($this->conn->query($sql)) { //if the execution of this line is okay
                ...
                # Check if there an uploaded file/photo, if there is a file/photo, save it to the 
                # database and move/save the file to the "images" folder
                if ($photo) {
